alert("规则:秀女、答应、常在、贵人、昭仪、嫔位、贵嫔、妃位、夫人、贵妃、皇后")
var game = {
        ...
        for (var i = 0; i < 4; i++) {
            for (var j = 0; j < 4; j++) {
                ...
                if (elemNum == 0) {
                    ...
                    element.innerHTML = "秀女";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==4){
                    element.innerHTML = "答应";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==8){
                    element.innerHTML = "常在";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==16){
                    element.innerHTML = "贵人";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==32){
                    element.innerHTML = "昭仪";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==64){
                    element.innerHTML = "嫔位";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==128){
                    element.innerHTML = "贵嫔";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==256){
                    element.innerHTML = "妃位";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==512){
                    element.innerHTML = "夫人";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==1024){
                    element.innerHTML = "贵妃";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==2048){
                    element.innerHTML = "皇后";

alert("游戏规则是：青铜、白银、黄金、铂金、钻石、星耀、最强王者、非凡王者、绝世王者、荣耀王者、传奇王者")
var game = {
        ...
        for (var i = 0; i < 4; i++) {
            for (var j = 0; j < 4; j++) {
                ...
                if (elemNum == 0) {
                    ...
                    element.innerHTML = "青铜";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==4){
                    element.innerHTML = "白银";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==8){
                    element.innerHTML = "黄金";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==16){
                    element.innerHTML = "铂金";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==32){
                    element.innerHTML = "钻石";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==64){
                    element.innerHTML = "星耀";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==128){
                    element.innerHTML = "最强王者";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==256){
                    element.innerHTML = "非凡王者";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==512){
                    element.innerHTML = "绝世王者";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==1024){
                    element.innerHTML = "荣耀王者";
                    
                    element.className = "elem_" + i + "_" + j + " " + "n" + elemNum;
                    
                }
                else if(elemNum==2048){
                    element.innerHTML = "传世王者";
